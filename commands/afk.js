...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
   ...
   message.channel.send(new MessageEmbed().setColor('RANDOM').setDescription(`${kullanıcı} Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${ramo}**`)).then(x => x.delete({timeout: 5000}));
